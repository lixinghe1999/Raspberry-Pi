...
void setup(){
  ...
  writeRegister8(0x53, 0x05); // enable INT1
  writeRegister8(0x58, 0x04); //map INT1
  pinMode(InterruptPin, INPUT);
  attachInterrupt(InterruptPin, isr, CHANGE); // attach interrupt to GPIO32
